...
export interface ApiGrupoGrupo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    colors: Attribute.Component<'proyectos.group-colors'> & Attribute.Required;
...
export interface ApiProyectoProyecto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    imagenPrincipal: Attribute.Media & Attribute.Required;
    descripcion: Attribute.Text & Attribute.Required;
    montoInversion: Attribute.Decimal & Attribute.Required;
    galeria: Attribute.Media;
    videoMaqueta: Attribute.Media;
    palabrasClave: Attribute.DynamicZone<['proyectos.palabras-clave']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
